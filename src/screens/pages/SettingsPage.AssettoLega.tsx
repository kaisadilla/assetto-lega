...
const ACCENT_SUGGESTIONS = [
    DEFAULT_SETTINGS['settings/accent'],
    "#57518b",
    "#00f7cb",
    "#00c232",
    "#ffcc00",
...
export interface SettingsPage_AssettoLegaProps {
    
}

function SettingsPage_AssettoLega (props: SettingsPage_AssettoLegaProps) {
...
export default SettingsPage_AssettoLega;
